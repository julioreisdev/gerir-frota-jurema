...
async function exportPDFCustom(title, cols, rows) {
  ...
  const html = pdfTemplate({ orgao, logo, ibge, now, period, entity_type: entity?.entity_type, body: `
...
async function exportPDF() {
  ...
  const html = pdfTemplate({ orgao, logo, ibge, now, period, entity_type: entity?.entity_type, body: kpisHTML + sectionsHTML });
